...
<\body>
  ...
  modification|The Macro editor is a \Pshortcut\Q tool that allows examining
  and modifying macro definitions. It can be used as well to write up a new
  macro starting from an existing macro; modifications are local to the file
  the Macro editor is invoked from.|Mon Mar \ 1 14:00:21 2021 GMT>

  <notes-entry|scheming.tm|Scheming|We discuss some aspects of the choice of
  the Scheme language implementation used in <TeXmacs>.|Mon Mar \ 1 13:56:48
  2021 GMT>
  ...
  Windows/Mac/Linux.|Mon Mar \ 1 13:56:48 2021 GMT>

  <notes-entry|main.tm|Notes on <TeXmacs>|(no abstract)|Mon Mar \ 1 13:56:48
  2021 GMT>
